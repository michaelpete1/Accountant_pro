...
export default function ContactPage() {
  ...
  return (
    <section className="max-w-4xl mx-auto px-6 py-20">
      ...
      >
        Whether you have questions, want a free consultation, or just want to say hello — 
        we're here to help! Reach out to Accountant Pro through any of the methods below.
      </p>
        ...
        {[
          {
            icon: (
              <svg
                ...
                aria-hidden="true"
              >
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2M7 8h2a2 2 0 012 2v6a2 2 0 01-2 2H7M7 8V6a4 4 0 014-4h2a4 4 0 014 4v2"></path>
              </svg>
            ),
            title: 'Address',
